...
// ... (Mantenha seus estilos originais aqui)
  ...
  drawer: { position: "fixed", top: 0, bottom: 0, right: 0, width: isMobile ? "50vw" : "400px", maxWidth: isMobile ? "90vw" : "400px", minWidth: isMobile ? "260px" : "auto", height: "100vh", backgroundColor: "#fff", borderLeft: "2px solid #000", padding: isMobile ? "0" : "10px 20px", boxShadow: "-4px 0 10px rgba(0,0,0,0.2)", zIndex: 1000, display: "flex", flexDirection: "column", transition: "transform 0.3s ease", overflowY: "auto", overflow: "visible" },
